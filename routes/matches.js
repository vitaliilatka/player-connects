...
//       let goalsPoints = scorerPoints + connectBonus;
//       totalPoints += goalsPoints;
...
//       let subsBonusFull =
//         actualSubs.length > 0 && subsCorrect === actualSubs.length ? 3 : 0;

//       let subsBonusCount =
//         predictedSubs.length === actualSubs.length ? 3 : 0;

//       let subsPoints = subsCorrect + subsBonusFull + subsBonusCount;
...
//       let goalsPoints = scorerPoints + assistPoints;
//       totalPoints += goalsPoints;
...
//           substitutions: {
//             correct: subsCorrect,
//             bonusFullMatch: subsBonusFull,
//             bonusCountMatch: subsBonusCount,
//             points: subsPoints
//           },
//           goals: {
//             scorerPoints,
